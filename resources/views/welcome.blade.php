...
<body class="selection:bg-secondary-container selection:text-white">
    ...
    <!-- Hero Section -->
    <header class="relative h-screen min-h-[700px] flex items-center overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-8 pt-[6rem] md:pt-0">
