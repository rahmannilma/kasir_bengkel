<?php $__env->startSection('title', 'Jasa Service - Bengkel POS'); ?>
...
<div class="grid grid-cols-3 gap-4 mb-6">
    <div class="bg-white rounded-lg shadow p-4">
        ...
        <p class="text-2xl font-bold"><?php echo e($services->total()); ?></p>
    </div>
    <div class="bg-white rounded-lg shadow p-4">
        <p class="text-sm text-gray-500">Kategori Service</p>
        <p class="text-2xl font-bold"><?php echo e($allCategories->count()); ?></p>
    </div>
    <div class="bg-white rounded-lg shadow p-4">
        <p class="text-sm text-gray-500">Total Pendapatan Jasa</p>
        <p class="text-2xl font-bold text-green-600">Rp <?php echo e(number_format($services->sum('price'), 0, ',', '.')); ?></p>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow mb-6">
    ...
    <div class="p-4 grid grid-cols-4 gap-3">
        ...
        <div class="border rounded-lg p-3 flex justify-between items-center">
            <div>
                <p class="font-medium"><?php echo e($category->name); ?></p>
                <p class="text-xs text-gray-500"><?php echo e($category->products_count ?? 0); ?> produk</p>
            </div>
            <div class="flex gap-1">
                <button onclick="editCategory(<?php echo e($category->id); ?>, '<?php echo e($category->name); ?>', 'service')" 
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="p-4 border-b">
        <form method="GET" class="flex gap-4">
            <input type="text" name="search" placeholder="Cari jasa..." value="<?php echo e(request('search')); ?>"
        ...
        <tbody class="divide-y">
            ...
            <tr>
                <td class="px-4 py-3">
                    ...
                    <p class="text-xs text-gray-500"><?php echo e(Str::limit($service->description, 50)); ?></p>
                    <?php endif; ?>
                </td>
                ...
                <td class="px-4 py-3 text-right text-sm font-medium">Rp <?php echo e(number_format($service->price, 0, ',', '.')); ?></td>
                <td class="px-4 py-3 text-center text-sm"><?php echo e($service->formatted_time); ?></td>
                <td class="px-4 py-3 text-center">
                    <?php if($service->is_active ?? true): ?>
                ...
                <td class="px-4 py-3 text-center">
                    <div class="flex justify-center gap-2">
                        <button onclick="editService(<?php echo e($service->id); ?>, '<?php echo e($service->name); ?>', <?php echo e($service->category_id ?? ''); ?>, <?php echo e($service->price); ?>, '<?php echo e($service->description ?? ''); ?>', <?php echo e($service->estimated_time ?? ''); ?>)" 
...
function showServiceModal() {
    ...
    document.getElementById('service-form').action = '<?php echo e(route('admin.services.store')); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\kasir_bengkel\resources\views/admin/services/index.blade.php ENDPATH**/ ?>