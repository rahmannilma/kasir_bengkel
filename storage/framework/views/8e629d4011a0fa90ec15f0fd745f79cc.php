<?php $__env->startSection('title', 'Kasir - Bengkel POS'); ?>
...
<div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col bg-gray-100">
        ...
        <div class="bg-white shadow p-4">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e(now()->format('d M Y, H:i')); ?> | <?php echo e(auth()->user()->name); ?></p>
                </div>
                <div class="flex gap-4">
                    <div class="text-right">
                        <p class="text-sm text-gray-500">Hari Ini</p>
                        <p class="text-lg font-bold text-green-600">Rp <?php echo e(number_format($todaySales, 0, ',', '.')); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-500">Transaksi</p>
                        <p class="text-lg font-bold"><?php echo e($todayTransactions); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border-b">
            <div class="flex overflow-x-auto" id="category-tabs">
                ...
                <button onclick="switchCategory('cat-product-<?php echo e($category->id); ?>')" data-type="product" class="cat-tab cat-tab-product whitespace-nowrap px-4 py-2 text-sm font-medium text-gray-500 hover:text-blue-600">
                    <?php echo e($category->name); ?>

                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if($productsWithoutCategory->isNotEmpty()): ?>
                ...
                <button onclick="switchCategory('cat-service-<?php echo e($category->id); ?>')" data-type="service" class="cat-tab cat-tab-service whitespace-nowrap px-4 py-2 text-sm font-medium text-gray-500 hover:text-blue-600 hidden">
                    <?php echo e($category->name); ?>

                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if($servicesWithoutCategory->isNotEmpty()): ?>
        ...
        <div class="flex-1 overflow-y-auto p-4" id="items-container">
            ...
            <div id="panel-all-product" class="category-panel" data-type="product">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    <?php $__currentLoopData = $productCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <button onclick="addItem('product', <?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', <?php echo e($product->selling_price); ?>, <?php echo e($product->stock); ?>)"
                            class="bg-white rounded-lg shadow p-4 text-left hover:shadow-lg transition h-32 flex flex-col justify-between
                            <?php echo e($product->stock <= $product->min_stock ? 'border-2 border-red-400' : ''); ?>"
                            data-name="<?php echo e(strtolower($product->name)); ?>" data-type="product" data-category-id="<?php echo e($category->id); ?>">
                            <div>
                                <p class="font-medium text-sm line-clamp-2"><?php echo e($product->name); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($category->name); ?></p>
                            </div>
                            <div class="flex justify-between items-end">
                                <p class="text-blue-600 font-bold">Rp <?php echo e(number_format($product->selling_price, 0, ',', '.')); ?></p>
                                <p class="text-xs text-gray-400">Stok: <?php echo e($product->stock); ?></p>
                            </div>
                        </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $productsWithoutCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="addItem('product', <?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', <?php echo e($product->selling_price); ?>, <?php echo e($product->stock); ?>)"
                        class="bg-white rounded-lg shadow p-4 text-left hover:shadow-lg transition h-32 flex flex-col justify-between
                        <?php echo e($product->stock <= $product->min_stock ? 'border-2 border-red-400' : ''); ?>"
                        data-name="<?php echo e(strtolower($product->name)); ?>" data-type="product" data-category-id="none">
                        <div>
                            <p class="font-medium text-sm line-clamp-2"><?php echo e($product->name); ?></p>
                ...
                <?php if($productCategories->isEmpty() && $productsWithoutCategory->isEmpty()): ?>
            ...
            <?php $__currentLoopData = $productCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div id="panel-cat-product-<?php echo e($category->id); ?>" class="category-panel hidden" data-type="product">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="addItem('product', <?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', <?php echo e($product->selling_price); ?>, <?php echo e($product->stock); ?>)"
                        class="bg-white rounded-lg shadow p-4 text-left hover:shadow-lg transition h-32 flex flex-col justify-between
            ...
            <div id="panel-all-service" class="category-panel hidden" data-type="service">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    <?php $__currentLoopData = $serviceCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <button onclick="addItem('service', <?php echo e($service->id); ?>, '<?php echo e(addslashes($service->name)); ?>', <?php echo e($service->price); ?>, 999)"
                            class="bg-white rounded-lg shadow p-4 text-left hover:shadow-lg transition h-32 flex flex-col justify-between"
                            data-name="<?php echo e(strtolower($service->name)); ?>" data-type="service" data-category-id="<?php echo e($category->id); ?>">
                            <div>
                                <p class="font-medium text-sm line-clamp-2"><?php echo e($service->name); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($category->name); ?></p>
                            </div>
                            <div class="flex justify-between items-end">
                                <p class="text-green-600 font-bold">Rp <?php echo e(number_format($service->price, 0, ',', '.')); ?></p>
                                <?php if($service->estimated_time): ?>
                                <p class="text-xs text-gray-400"><?php echo e($service->formatted_time); ?></p>
                                <?php endif; ?>
                            </div>
                        </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $servicesWithoutCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="addItem('service', <?php echo e($service->id); ?>, '<?php echo e(addslashes($service->name)); ?>', <?php echo e($service->price); ?>, 999)"
                        class="bg-white rounded-lg shadow p-4 text-left hover:shadow-lg transition h-32 flex flex-col justify-between"
                        data-name="<?php echo e(strtolower($service->name)); ?>" data-type="service" data-category-id="none">
                        <div>
                            <p class="font-medium text-sm line-clamp-2"><?php echo e($service->name); ?></p>
                            <p class="text-xs text-gray-500">Tanpa Kategori</p>
                        </div>
                ...
                <?php if($serviceCategories->isEmpty() && $servicesWithoutCategory->isEmpty()): ?>
            ...
            <?php $__currentLoopData = $serviceCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div id="panel-cat-service-<?php echo e($category->id); ?>" class="category-panel hidden" data-type="service">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    <?php $__currentLoopData = $category->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="addItem('service', <?php echo e($service->id); ?>, '<?php echo e(addslashes($service->name)); ?>', <?php echo e($service->price); ?>, 999)"
                        class="bg-white rounded-lg shadow p-4 text-left hover:shadow-lg transition h-32 flex flex-col justify-between"
    ...
    <div class="w-96 bg-white shadow-xl flex flex-col">
        ...
        <form id="transaction-form" action="<?php echo e(route('transactions.store')); ?>" method="POST" class="flex-1 flex flex-col">
            <?php echo csrf_field(); ?>
            ...
            <div class="p-4 border-b">
                ...
                <div class="space-y-2 max-h-32 overflow-y-auto border rounded-lg p-2" id="mechanics-container">
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-1 rounded">
                        <input type="checkbox" name="mechanic_ids[]" value="<?php echo e($mechanic->id); ?>" class="rounded text-blue-600">
                        <span class="text-sm"><?php echo e($mechanic->name); ?><?php echo e($mechanic->specialization ? ' - ' . $mechanic->specialization : ''); ?></span>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
document.getElementById('add-service-form').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('<?php echo e(route('kasir.services.store')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\kasir_bengkel\resources\views/kasir/index.blade.php ENDPATH**/ ?>