...
<?php $__env->startSection('title', 'Laporan Penjualan - Bengkel POS'); ?>
...
<div class="bg-white rounded-lg shadow p-4 mb-6">
    <form method="GET" class="flex flex-wrap gap-4 items-end">
        ...
        <a href="<?php echo e(route('admin.reports.sales-export', ['date_from' => $dateFrom, 'date_to' => $dateTo])); ?>" target="_blank" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-green-600">Rp <?php echo e(number_format($totalSales, 0, ',', '.')); ?></p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-blue-600"><?php echo e($totalTransaction); ?></p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-purple-600"><?php echo e($totalItems); ?></p>
            </div>
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    ...
    <table class="w-full">
        ...
        <tbody class="divide-y">
            ...
            <tr>
                <td class="px-4 py-3 font-mono text-sm"><?php echo e($t->invoice_number); ?></td>
                <td class="px-4 py-3 text-sm"><?php echo e($t->created_at->format('d/m/Y H:i')); ?></td>
                <td class="px-4 py-3 text-sm"><?php echo e($t->customer->name ?? '-'); ?></td>
                <td class="px-4 py-3 text-sm"><?php echo e($t->user->name); ?></td>
                <td class="px-4 py-3 text-right font-medium">Rp <?php echo e(number_format($t->total, 0, ',', '.')); ?></td>
            </tr>
        ...
        <tfoot class="bg-gray-50 font-bold">
            <tr>
                ...
                <td class="px-4 py-3 text-right text-green-600">Rp <?php echo e(number_format($totalSales, 0, ',', '.')); ?></td>
            </tr>
        </tfoot>
        <?php endif; ?>
    </table>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\kasir_bengkel\resources\views/admin/reports/sales.blade.php ENDPATH**/ ?>